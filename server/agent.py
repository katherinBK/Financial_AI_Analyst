...
def build_agent():
    ...
    prompt = ChatPromptTemplate.from_messages([
("system", """Eres un asistente experto en análisis de trading. Tu tarea es:
1. Analizar la información proporcionada
2. Usar las herramientas disponibles cuando sea necesario para calcular valores
3. Proporcionar un análisis claro y estructurado
...
- kelly_Criterion_formula: Calcula fracción óptima de Kelly (win_Rate, loose_probability, win_ratio)

Instrucciones:
- Usa las herramientas para obtener cálculos precisos
